...
const couponsSchema = Joi.object({
    ...
    date_expires: Joi.string().allow(null).required(),
    date_expires_gmt: Joi.string().allow(null).required(),
    ...
    usage_limit: Joi.string().allow(null).required(),
    usage_limit_per_user: Joi.string().allow(null).required(),
    limit_usage_to_x_items: Joi.string().allow(null).required(),
